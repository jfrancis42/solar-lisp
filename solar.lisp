	   ...
	   (json:decode-json-from-string
	    (babel:octets-to-string
	     (first
	      (multiple-value-list
	       (drakma:http-request
		"http://services.swpc.noaa.gov/products/noaa-estimated-planetary-k-index-1-minute.json"
		:method :get))))))))))
  ...
  (json:decode-json-from-string
   (babel:octets-to-string
    (first
     (multiple-value-list
      (drakma:http-request
       "http://services.swpc.noaa.gov/products/latest-xray-event.json"
       :method :get))))))
